  ...
  return (
    <footer>
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; Klientomat.pl - Wszelkie prawa zastrzeżone.
            </div>
          </div>
          ...
          {/* 5th block */}
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h3 className="text-sm font-medium">Media społecznościowe</h3>
      ...
      <div className="relative -mt-16 h-60 w-full -z-10" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[268px] font-bold leading-none before:bg-gradient-to-b before:from-gray-200 before:to-gray-180/80 before:to-50% before:bg-clip-text before:text-transparent before:content-['Klientomat'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Klientomat'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div
