        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-24 text-center md:pb-28">
            <h2 className="mb-4 text-3xl font-bold md:text-4xl">
              Zdobądź Idealne Leady w Mgnieniu Oka
            </h2>
            <p className="text-lg text-gray-700">
            Korzystaj z intuicyjnych i zaawansowanych narzędzi, które przyspieszą Twoje działania. Twórz idealne kampanie i automatyzacje, korzystając z dobrze znanych rozwiązań i możliwości integracji z Twoimi ulubionymi platformami.
            </p>
          </div>
          {/* Illustration */}
          <div
          ...
          <div className="grid overflow-hidden border-y [border-image:linear-gradient(to_right,transparent,theme(colors.slate.200),transparent)1] lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gradient-to-b [&>*]:before:from-transparent [&>*]:before:via-gray-200 [&>*]:before:[block-size:100%] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] md:[&>*]:px-10 md:[&>*]:py-12">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium">
                ...
                <span>Olbrzymia Baza Leadów</span>
              </h3>
              <p className="text-[15px] text-gray-700">
              Z ponad 950 milionami leadów B2B do wyboru, znajdziesz dokładnie leady, które potencjalnie są zainteresowane Twoją ofertą.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium">
                ...
                <span>100% Zweryfikowane E-maile</span>
              </h3>
              <p className="text-[15px] text-gray-700">
              Zbyt często maile trafiają do kosza.
              Z nami nie musisz się martwić – każdy adres e-mail jest dwukrotnie weryfikowany. Brak odbić, brak frustracji.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium">
                ...
                <span>100% Zgodność z RODO</span>
              </h3>
              <p className="text-[15px] text-gray-700">
                Żadnych personalnych baz danych, żadnych nielegalnych praktyk.
                My dbamy o Twoje bezpieczeństwo, a Ty możesz spać spokojnie.
              </p>
            </article>
          </div>
        </div>
