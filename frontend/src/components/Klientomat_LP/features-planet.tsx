        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Globalne Narzędzie do Automatyzacji i Optymalizacji Kampanii.
              Twórz, Wysyłaj i Analizuj Skutecznie na Całym Świecie!
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Zbieraj dane o otwarciach, kliknięciach i odpowiedziach, by optymalizować swoje działania.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Szybka automatyzacja</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Pozyskuj klientów szybciej niż kiedykolwiek wcześniej dzięki automatyzacji procesów wysyłki i personalizacji emaili.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Dostosowywanie wiadomości</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Twórz wiadomości, które naprawdę angażują dzięki zaawansowanej personalizacji.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Obsługa wielojęzyczna</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Docieraj do klientów na całym świecie dzięki lokalizacji i wsparciu wielu języków.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Zaawansowane raportowanie</span>
              </h3>
              <p className="text-[15px] text-gray-400">
              Przejrzyste raporty pokazujące, co działa, a co wymaga poprawy w Twoich kampaniach.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Segmentacja odbiorców</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Twórz precyzyjne grupy docelowe, aby dostarczać bardziej trafne i skuteczne komunikaty do różnych segmentów klientów.
              </p>
            </article>
          </div>
        </div>
